...
FALLBACK_DETECTOR_VERSION = "deterministic-c01-c07-v5"
...
# This bounded ceiling covers the 236,991,870-byte official training CSV.
MAX_STREAMING_CSV_BYTES = 256 * 1024 * 1024
MAX_STREAMING_CSV_ROWS = 600_000
STREAMING_CSV_CHUNK_BYTES = 8 * 1024 * 1024
